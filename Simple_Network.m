...
%%                              #### Sart ####
    ...
    DSSText.Command = 'Compile (F:\My_DSS_Work\Congestion-Management\Simple_Network.dss)'; % Change directory to your specified disk                           
    
    DSSText.Command = 'Set ControlMode = time';
    DSSText.Command = 'Reset';
    DSSText.Command = 'Set Mode = Yearly Number = ' + string(hours); % This line should be activated for normal operation for VAR comment this line
%     DSSText.Command = 'Set Mode=yearly number=1';  % Uncomment this line when implementing Auto VAR compensation (Controlled Operation)
...
%     DSSText.Command = "Set Loadmult= " + string(Dgrowth);
    ...
    % To create even further  problems we will increase the reactive power demand of bus c
...
%     DSSCircuit.Generators.kW = DSSCircuit.Generators.kW * Ggrowth;
    ...
    % 2) VAR Compensation (Controlled Operation)
...
%     end
    ...
    DSSSolution.Solve % This line should be activated for normal operation for VAR operation coment this line
